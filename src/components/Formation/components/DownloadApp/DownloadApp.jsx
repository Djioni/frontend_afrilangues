    ...
    <div>
      <div>
        ...
        <div className="download_container ms-2">
          <p>
            Profitez de votre temps libre pour apprennez une langue africaine
            avec un parcours complet partout et à tout moment !
          </p>
        </div>
      </div>
      ...
      <div className=" tw-pt-[55px] tw-flex tw-justify-center tw-flex-col md:tw-flex-row tw-gap-5 ">
        <div className="tw-col-span-4 md:tw-col-span-2 tw-flex tw-flex tw-justify-center">
          <a href="https://apps.apple.com/fr/app/afrilangues-officiel/id1511912820">
            <img src={applestore} alt="" className=" " />
          </a>
        </div>
        <div className="tw-col-span-4 md:tw-col-span-2  tw-flex tw-justify-center">
          <a
            href="https://play.google.com/store/apps/details?id=com.afrilangues.app"
            className="tw-pt[20px] sm:tw-pt-[0px]"
          >
