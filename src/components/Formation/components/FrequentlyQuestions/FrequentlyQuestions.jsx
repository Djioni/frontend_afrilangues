  ...
  const data = [
    {
      ...
      answer: null,
      anwserList: [
        {title:"Cours en présentiel ou à distance :",
        list: [],
        },
        {
          title: "Cours en présentiel :  ",
          list: [
            "Il s’agit de cours collectifs ou particuliers en face à face avec l’enseignant soit dans nos locaux, chez vous ou sur votre lieu de travail." ,
            "Pour les cours collectifs, ils ont lieu une fois par semaine à raison d’une heure et demie par séance. ",
            "Quant aux cours particuliers en présentiel, c’est vous qui déterminez le volume horaire souhaité ainsi que vos disponibilités.",
          ],
        },
        {
          title: "Cours à distance :  ",
          list: [
            "Ce sont des cours collectifs ou particuliers par visio-conférence qui ont lieu sur notre plateforme. ",
            "S’agissant des cours collectifs, la fréquence est d’une fois par semaine à d’une heure et demie, soit 6 heures de cours par mois du lundi au samedi.",
            "Quant aux cours particuliers, c’est vous qui déterminez le volume horaire souhaité ainsi que vos disponibilités. ",
          ],
        },
        {
          ...
          list: [
            ...
            "Une fois inscrit, vous pouvez vous plongez dans la langue africaine de votre choix gratuitement.",
          ],
        },
      ],
    },

    {
      ...
      answer:
        "À ce jour, nous enseignons le Bambara, le Soninké, le Wolof, le Sérère, le Lingala, le Laari, le Swahili, le Pulaar, le Fon, le Mina, le Duala, l’Amharique, le Sango, le Bassa, le Yoruba, le Mooré, le Baoulé, le Bété, l’Ewondo, le Ghomala, le Kirundi, le Kinyarwanda. Cette liste n’est pas exhaustive et s’agrandit au fur et à mesure des demandes reçues.",
      anwserList: null,
    },
    {
      ...
      anwserList: [
        {
          title: "",
          list: [
            "L’Afrique compte plus de 2 000 langues. Malgré notre bonne volonté, nous ne pouvons pas rendre disponible toutes les langues. Leur présence dépend de la demande et de la disponibilité des enseignants qualifiés.",
            "Si vous ne trouvez pas votre langue, écrivez-nous à contact@afrilangues.fr et nous nous chargerons de faire de notre mieux pour trouver un enseignant qualifié. ",
          ],
        },
      ],
    },
      ...
      anwserList: [
        {
          ...
          list: [
            ...
            "Nous vous promettons de vous donner les clés pour apprendre le vocabulaire, la grammaire et les activités nécessaires à la production et l’expression orale. Mais sachez que malgré tout l’amour qu’on peut vous porter, nous ne pouvons pas apprendre à votre place ! Comme disent les Bambara « Kun tɛ di kuntigi kɔ. » Ce qui signifie « On ne peut pas raser la tête de quelqu’un en son absence. ».",
            "Plus vous serez régulier dans vos apprentissages, en alliant cours collectifs et l’utilisation de l’application mobile en complément ou d’autres ressources pédagogiques, plus vous serez capable de vous exprimer aisément et d’atteindre vos objectifs.",
          ],
        },
      ],
    },
      ...
      anwserList: [
        {
          title: "",
          list: [
            "Oui, nos cours collectifs et particuliers sont payants mais très accessibles.",
            "La création de contenus pédagogiques nécessite du temps et surtout des ressources considérables. Donc, l’inscription à nos cours nous permet de rémunérer de prime abord nos enseignants, acheter du matériel d’enregistrement audio et vidéo, faire faire des illustrations, la maintenance de la plateforme etc.",
            "Malgré toutes ces dépenses, nous avons décidé de rendre gratuit nos cours en auto-apprentissage contre le visionnage d’une publicité afin de financer ceux-ci.",
          ],
        },
      ],
    },
      ...
      <div className="frequently_questions_container container">
        <div className="heading_container">
          <h2>
            {/* Frequently <span>a
            sked</span> */}
            <span>FAQ</span> <br/> LES <span>QUESTIONS</span> FREQUENTES
          </h2>
          <p>
