    ...
    <div className="testimonials_wrapper">
      <div className="testimonials_container container">
        <div className="heading_container">
          ...
          <p>
            AFRILANGUES, c'est des méthodes d'apprentissage faites par nous, pour vous ! Les avis de nos élèves
            et utilisateurs sont donc précieux! Voici ce que VOUS en pensez.
          </p>
        </div>
