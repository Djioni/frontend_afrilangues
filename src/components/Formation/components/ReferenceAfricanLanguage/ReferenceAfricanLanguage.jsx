      ...
      <div className="ref_african_language_container container ">
        ...
        <div className="row mt-5 mx-auto text-center">
          <div className="col-12 col-sm-6 col-lg-2 me-lg-3 px-4 px-lg-0">
            <img src={voc} alt="Vocabulaire" className="img-fluid custom-image-size" />
            <h2>Vocabulaire</h2>
          <p className="paragraph"> Apprendre le vocabulaire de la leçon avec des activités ludiques comprenant
              des fichiers audios.
            </p>
          </div>
          <div className="col-12 col-sm-6 col-lg-2 mx-lg-3 px-4 px-lg-0 ">
            <img src={gram} alt="Grammaire" className="img-fluid custom-image-size" />
            <h2>Grammaire</h2>
            <p className="paragraph">Apprenez les règles de fonctionnement de la langue grâce à des exercices d'applications faciles</p>
          </div>
          <div className="col-12 col-sm-6 col-lg-2 mx-lg-3 px-4 px-lg-0 ">
            <img src={phrases} alt="Phrases" className="img-fluid custom-image-size" />
            <h2>Phrases</h2>
            <p className="paragraph">Construisez des phrases avec les mots appris dans la section vocabulaire.</p>
          </div>
          <div className="col-12 col-sm-6 col-lg-2 mx-lg-3 px-4 px-lg-0 ">
            <img src={dial} alt="Dialogue" className="img-fluid custom-image-size" />
            <h2>Dialogues</h2>
            <p className="paragraph">Utilisez les phrases apprises dans un dialogue contextuel pour faciliter la production et la compréhension
              orale.
            </p>
          </div>
          <div className="col-12 col-sm-6 col-lg-2 mx-lg-3 mx-auto px-4 px-lg-0 ">
            <img src={stat} alt="Progression" className="img-fluid custom-image-size" />
            <h2>Statistiques</h2>
            <p className="paragraph">Mesurez votre progression et développez vos compétences grâce à notre système
