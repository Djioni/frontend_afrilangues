...
function Devis() {
  ...
  const handleAddLanguage = () => {
    if (selectedLanguage && sourceLanguage && serviceDate && (link || serviceType)) {
      const formattedDate = new Date(serviceDate).toLocaleDateString('fr-FR');
      setLanguages([...languages, { sourceLanguage, language: selectedLanguage.label, date: formattedDate, link, serviceType }]);
  ...
  return (
    <div className="App" style = {{
      ...
      <Container>
        ...
        <Paragraph className='text-center'>Vous avez un support écrit ou audiovisuel à traduire, transcrire ou sous-titrer ?<br />Nous mettrons à votre disposition nos traducteurs professionnels pour traduire le plus fidèlement possible.</Paragraph>
        <section className="contact">
          ...
          <form>
            ...
            <div className="form-group">
              ...
              <select id="serviceType" className="input-style" value={serviceType} onChange={(e) => setServiceType(e.target.value)}>
            ...
            <div className="form-group">
              <label htmlFor="link">ou COPIEZ ET COLLEZ LE LIEN DE REDIRECTION VERS CELUI-CI :</label>
              <input type="text" id="link" placeholder="Lien de redirection" className="input-style" value={link} onChange={(e) => setLink(e.target.value)} />
            </div>
            <div className="form-group">
            <label htmlFor="sourceLanguage">LANGUE SOURCE DU SUPPORT : <span className="required">*</span></label>
              <Select
                id="language"
            ...
            <div className="form-group">
              <label htmlFor="language">LANGUE CIBLE : <span className="required">*</span></label>
              <Select
                id="language"
                options={sortedLanguageOptions}
                styles={customStyles}
            ...
            <div className="form-group">
              <label htmlFor="serviceDate">DATE DE LA LIVRAISON SOUHAITÉE :</label>
              ...
              <div className="reservation-summary">
                ...
                {languages.map((lang, index) => (
                  <div key={index} className="selected-language">
                    ...
                    <span className="column">{lang.serviceType === 'traduction' ? 'Traduction de support' : lang.serviceType === 'sous-titrage' ? 'Sous-titrage de support' : lang.serviceType === 'transcription' ? 'Transcription de support' : 'Réalisation de voix-off'}</span>
                  </div>
                ))}
              </div>
            </div>
